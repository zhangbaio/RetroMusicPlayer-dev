    ...
    companion object {
        ...
        fun primaryColor(context: Context): Int {
            return prefs(context).getInt(
                ...
                resolveColor(context, androidx.appcompat.R.attr.colorPrimary, Color.parseColor("#FC3C44"))
            )
        }
        ...
        fun accentColor(context: Context): Int {
            ...
            val color = if (isWallpaperAccentEnabled(context)) {
                ...
                prefs(context).getInt(
                    ...
                    resolveColor(context, androidx.appcompat.R.attr.colorAccent, Color.parseColor("#FC3C44"))
                )
            }
